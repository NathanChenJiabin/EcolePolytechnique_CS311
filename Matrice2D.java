...
public class Matrice2D {
	...
	private BigInteger[] coeff; // coefficients de la matrice, stoqués par lignes {M00, M01, M10, M11}
	 ...
	 * Remarque: les coefficients de la matrice sont stoqués par lignes {M00, M01, M10, M11}
	 * 
	 * @param i
	 * 			indice du coefficient à renvoyer
	 * @return
	 * 			la valeur du coefficient stoqué dans la matrice
	 */
	private BigInteger getCoefficient(int i) {
		if(i<0 || i>=4)
